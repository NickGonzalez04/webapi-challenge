...
- [X] Mention two parts of Express that you learned about this week.
        - I learned that express enables extra functionality to our backend. It helps with routing and middleware being abel to be used as the framework to our backend.
- [X] Describe Middleware?
    - Middleware is either a third party, custom, build in that allows us to add features to express.

- [X] Describe a Resource?
    In what context? Express documents is a resource.
- [X] What can the API return to help clients know if a request was successful?
    - Can return status code or data
- [X] How can we partition our application into sub-applications?
    - We can do this by breaking down our server into routes and separating our middleware from the the requests and passing them into our requests.
## Project Setup
